...
export type GetCategoriesQuery = { __typename?: 'Query', categories: Array<{ __typename?: 'Category', id: number, name: string, value: string, count: number, active: boolean }> };
...
export const GetQuestionsByCategoryDocument = gql`
    query getQuestionsByCategory($category_ids: [Int!], $page: Int, $search: String, $page_size: Int) {
  questionsByCategory(
